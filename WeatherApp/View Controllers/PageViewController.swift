...
//hiển thị thông tin vị trí hiện tại và đã lưu
import UIKit
import CoreLocation
...
class PageViewController: UIViewController {
    ...
    @objc func presentLocationListViewController() {
        guard let locationListViewController = mainStoryboard.instantiateViewController(withIdentifier: LocationListViewController.identifier) as? LocationListViewController else {
            return
        }
...
extension PageViewController: UIPageViewControllerDataSource {
    func weatherViewController(at index: Int) -> UIViewController {
        ...
        guard let createdWeatherViewController = mainStoryboard.instantiateViewController(withIdentifier: WeatherViewController.identifier) as? WeatherViewController else {
